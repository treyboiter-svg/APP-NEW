...
_TID: dict = {
    ...
    ("nhl","Jets"):"nhl_jets",
    # WNBA
    ("wnba","Dream"):"wnba_dream",
    ("wnba","Sky"):"wnba_sky",
    ("wnba","Sun"):"wnba_sun",
    ("wnba","Wings"):"wnba_wings",
    ("wnba","Fever"):"wnba_fever",
    ("wnba","Sparks"):"wnba_sparks",
    ("wnba","Lynx"):"wnba_lynx",
    ("wnba","Liberty"):"wnba_liberty",
    ("wnba","Mercury"):"wnba_mercury",
    ("wnba","Storm"):"wnba_storm",
    ("wnba","Mystics"):"wnba_mystics",
    ("wnba","Aces"):"wnba_aces",
